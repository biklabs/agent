...
const PRESETS: Record<RuntimeType, RuntimePreset> = {
  claude_code: {
    ...
    requiredEnv: [],
    optionalEnv: ["CLAUDE_BIN", "BIK_PM_MCP_TOKEN", "BIK_PM_MCP_URL"],
    smokeVersionArgs: ["--version"],
    smokeHelpArgs: ["--help"],
    notes: "Native adapter in runner/session-client with MCP config file support.",
  },
  codex: {
    runtimeType: "codex",
    displayName: "Codex",
    ...
    smokeVersionArgs: ["--version"],
    smokeHelpArgs: ["--help"],
    notes: "Native adapter in runner/session-client using Codex MCP runtime flags.",
  },
  cursor: {
    runtimeType: "cursor",
